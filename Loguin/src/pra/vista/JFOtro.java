 ...
 * @author jhone
 */
public class JFOtro extends javax.swing.JFrame {

    /**
     * Creates new form JFOtro
     */
    public JFOtro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFOtro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
